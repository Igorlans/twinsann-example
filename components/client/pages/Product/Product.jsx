...
const Product = ({product, similarProducts, relatedProducts}) => {
    ...
    return (
        <>
            ...
            <SeoBlock
                title={product?.name}
                ogTitle={`${product?.name} всього за ${product?.price}₴`}
                description={
            ...
            <div className={classes.productPage}>
                ...
                <div className={classes.sides}>
                    ...
                    <div className={classes.infoSide}>
                        <h1 className={classes.title}>{dbTranslate(product, 'name')}</h1>
