			...
			<div className={styles.container}>
				...
				<div className={styles.layout}>
					<div className={styles.article}>
						...
						{/*	<SwiperComponent*/}
						{/*		children={*/}
						{/*			post.Subcategory?.Products ?? post.Category.Products*/}
						{/*		}*/}
						{/*		settings={data.swiper.settings.cards} type="cards"/>*/}
						{/*</div>*/}
						...
						<CategorySlider
							...
							style={{color: "#000"}}
							settings={data.swiper.settings.cards}
							type="cards"
						/>
						...
						<div className={classes.lastViewed}>
							...
							<SwiperComponent children={relatedProduct} settings={data.swiper.settings.cards} type="cards"/>
						</div>
