                    ...
                    <div className={classes.col}>
                        ...
                        <div className={classes.item}>
                            <a target="_blank" href="https://maps.app.goo.gl/2QmRZhwGTfrxL7YYA">
                                Проспект Космонавтів 49, ЖК «Premier Tower», перший поверх
                            </a>
                            </div>
                        <div className={classes.item}><a target="_blank" href="tel:+38 (073) 999 00 77">{footer("hotline")}: <br/>+38 (073) 999 00 77</a></div>
                        <div className={classes.item}><a target="_blank" href="tel:+38 (093) 87 057 47">{footer("salesDepartment")}: <br/>+38 (063) 161 04 27</a></div>
