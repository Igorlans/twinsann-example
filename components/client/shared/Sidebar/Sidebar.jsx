...
import {useIsMobile} from "@/components/client/hooks/useIsMobile";
// import logo from  '../../assets/icons/TwinSann.svg'
...
import useMediaQuery from "@/components/client/hooks/useMediaQuery";
            ...
            <>
                ...
                >
                    ...
                    <div className={classes.columns}>
                        ...
                        >
                            <GrClose fill={"#fff"} size={'1.8em'} onClick={() => dispatch(setSidebarVisibilityAction(false))}/>
                        </motion.div>
                    </div>
                        ...
                        !isLoading
                            ...
                            <>
                                <div style={{display: 'flex', flexDirection: 'column', gap: 20}}>
                                    ...
                                    <Skeleton variant={'rounded'} height={30} width={'100%'} />
                                    <Skeleton variant={'rounded'} height={30} width={'100%'} />
                                    {/*<Skeleton variant={'rounded'} height={30} width={'100%'} style={{background: '#454648'}}/>*/}
                                </div>
                            </>
